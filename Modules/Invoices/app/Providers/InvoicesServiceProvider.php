...
use Modules\Invoices\Jobs\InvoiceStatusConditionJob;
...
class InvoicesServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommandSchedules(): void
    {
        ...
        $this->app->booted(function () {
            app(Schedule::class)->job(new InvoiceAfterDueJob)->dailyAt('01:00');
            app(Schedule::class)->job(new InvoiceBeforeDueJob)->dailyAt('01:00');
            app(Schedule::class)->job(new InvoiceStatusConditionJob)->dailyAt('01:00');
        });
    }
