...
use Modules\Leads\Jobs\LeadStatusConditionJob;
...
class LeadsServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommandSchedules(): void
    {
        ...
        $this->app->booted(function () {
            app(Schedule::class)->job(new LeadNoActionJob)->dailyAt('01:00');
            app(Schedule::class)->job(new LeadStatusConditionJob)->dailyAt('01:00');
        });
    }
