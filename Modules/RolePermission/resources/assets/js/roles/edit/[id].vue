    ...
    <VForm ref="refForm" @submit.prevent="onSubmit">
      <VCard class="pa-5">
        <div class="d-flex justify-space-between align-center mb-5">
          ...
          <div class="d-flex gap-2">
            <VBtn v-if="$can('role', 'edit')" color="primary" type="submit"
              :disabled="role_slug == SLUG_SUPER_ADMIN ? true : false">
              Save</VBtn>
      ...
      <div v-else>
        ...
        <VWindow v-model="currentTab">
          <VWindowItem v-for="permissionType in permissionList" :value="permissionType.id" :key="permissionType.id">
            <VRow class="d-flex">
...
const getRoleInfo = async () => {
  try {
    ...
    if (response.status === 200) {
      ...
      role_slug.value = response.data ? response.data.slug : '';
