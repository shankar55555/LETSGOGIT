...
<template>
  ...
  <VDialog max-width="500" :model-value="props.isDialogVisible" @update:model-value="updateModelValue">
    <VCard class="text-center px-10 py-6">
      ...
      <VCardText class="d-flex align-center justify-center gap-2">
        <VBtn variant="elevated" color="warning" @click="onConfirmation">
          Yes, Continue
        </VBtn>
  ...
  <!-- Confirmed - Continue without GST -->
  ...
  <!-- <VDialog v-model="cancelled" max-width="500">
    <VCard>
      <VCardText class="text-center px-10 py-6">
        <VBtn icon variant="outlined" color="info" class="my-4"
          style=" block-size: 88px;inline-size: 88px; pointer-events: none;">
          <VIcon icon="tabler-info-circle" size="38" />
        </VBtn>
        ...
        <VBtn color="primary" @click="cancelled = false">
          Ok
        </VBtn>
      </VCardText>
    </VCard>
