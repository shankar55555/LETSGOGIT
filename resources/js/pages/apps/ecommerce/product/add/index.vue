      ...
      <VCol md="8">
        ...
        <VCard title="Variants" class="mb-6">
          <VCardText>
            ...
            <VBtn class="mt-6" prepend-icon="tabler-plus" @click="optionCounter++">
              Add another option
            </VBtn>
          </VCardText>
        </VCard>
                  ...
                  <VWindowItem value="Advanced">
                    <div class="ps-3">
                      ...
                      <div class="d-flex flex-sm-row flex-column flex-wrap justify-space-between gap-x-6 gap-y-4">
                        <AppSelect label="Product ID Type" placeholder="Select Product Type"
      ...
      <VCol md="4" cols="12">
        ...
        <VCard title="Pricing" class="mb-6">
          <VCardText>
            ...
            <VCheckbox v-model="isTaxChargeToProduct" label="Charge  on this product" />
        ...
        <VCard title="Organize">
          <VCardText>
            <div class="d-flex flex-column gap-y-4">
              <AppSelect placeholder="Select Vendor" label="Vendor"
              ...
              <AppSelect placeholder="Select Collection" label="Collection"
                :items="['Men\'s Clothing', 'Women\'s Clothing', 'Kid\'s Clothing']" />
              <AppSelect placeholder="Select Status" label="Status" :items="['Published', 'in-active', 'Scheduled']" />
