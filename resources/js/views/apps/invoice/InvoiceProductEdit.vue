...
<template>
  ...
  <VCard flat border class="d-flex flex-sm-row flex-column-reverse">
    ...
    <div class="pa-6 flex-grow-1">
      <VRow>
        <VCol cols="12" md="6">
          <AppSelect v-model="selectedItem" :items="itemsOptions" item-title="title" item-value="title"
            placeholder="Select Item" class="mb-6" />

          <AppTextarea v-model="localProductData.description" rows="2" placeholder="Item description"
            persistent-placeholder />
        </VCol>
        <VCol cols="12" md="2" sm="4">
          <AppTextField v-model="localProductData.cost" type="number" placeholder="Cost" class="mb-6" />
          ...
          <div class="text-high-emphasis text-no-wrap mt-4">
            ...
            <span class="mx-2">
              0%
              <VTooltip activator="parent">GST 1</VTooltip>
            </span>
            <span>
              0%
              <VTooltip activator="parent">GST 2</VTooltip>
            </span>
          </div>
        </VCol>
        <VCol cols="12" md="2" sm="4">
          <AppTextField v-model="localProductData.hours" type="number" placeholder="5" />
        </VCol>
        <VCol cols="12" md="2" sm="4">
          <p class="my-2">
